...
function Profile() {
  ...
  const getProfileImg = (seeProfile: seeProfile_seeProfile) => {
    const { avatar } = seeProfile;
    if (avatar) {
      return <ProfileImg src={avatar} />;
    } else {
      return <ProfileImg />;
    }
  };
  ...
  return (
    <div>
      ...
      />
      <Header>
        {data?.seeProfile && getProfileImg(data.seeProfile)}
        <Column>
          <Row>
